class Solution {
    ...
    longestConsecutive(nums) {
         ...
         * do that.
         * We can use a hash set to store all numbers in the nums array and loop over the array once
         * and for every number we check if the next number is present in the hash set, if so we
         * update the length. We keep track of the maximum length and the current length of the
         * consecutive numbers.  
         * Time: O(n)
         * Space: O(n)
         */
