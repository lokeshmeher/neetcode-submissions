class Solution {
    ...
    twoSum(nums, target) {
        ...
        //     }
        //     else {
        //         return [idx[0], other[0]];
        //     }
        // }

        /**
         * There is a simpler way to do it since in the problem statement we are given that 
         * there will be exactly one pair of indices that satisfy the condition.
         * 
         * We can create the hashmap and check for the value in the same iteration.
         * Below code demonstrates this.
         */
        let valueToIndex = new Map();
        for (let [index, num] of nums.entries()) {
            if (valueToIndex.has(target-num)) {
                return [valueToIndex.get(target-num), index]
            }
